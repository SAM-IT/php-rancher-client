...
class HostTemplate extends \SamIT\Rancher\Types\Entity
{
	...
	public static $entityLinks = [
		'self' => 'https://rancher.sam-it.eu/v2-beta/schemas/hosttemplate',
		'collection' => 'https://rancher.sam-it.eu/v2-beta/hosttemplates',
	];
	...
	public static function create(JsonMap $secretValues, JsonMap $publicValues)
	{
		...
		$result->publicValues = $publicValues;
		return $result;
	}
